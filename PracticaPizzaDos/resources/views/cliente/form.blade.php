...
<div class="form-group {{ $errors->has('pais') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pais" type="text" id="pais" value="{{ isset($cliente->pais) ? $cliente->pais : ''}}" >
    {!! $errors->first('pais', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('ciudad') ? 'has-error' : ''}}">
    <label for="ciudad" class="control-label">{{ 'Ciudad' }}</label>
    <input class="form-control" name="ciudad" type="text" id="ciudad" value="{{ isset($cliente->ciudad) ? $cliente->ciudad : ''}}" >
...
<div class="form-group {{ $errors->has('codigoPostal') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="codigoPostal" type="text" id="codigoPostal" value="{{ isset($cliente->codigoPostal) ? $cliente->codigoPostal : ''}}" >
